          ...
          <div className="flex flex-col w-[66%] max-md:w-full">
            <div className="flex flex-col self-stretch my-auto text-slate-800 max-md:mt-10">
              ...
              <p className="mt-11 text-base max-md:mt-6 max-md:text-center">
                Hi, I'm Anup, a Full Stack Developer with a passion for creating
                dynamic web applications. I excel at both front-end and back-end
                development, ensuring efficient and scalable solutions.
              </p>
            </div>
          </div>
