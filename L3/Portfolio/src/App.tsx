  ...
  return (
    <div className="App">
      <div className="flex overflow-hidden flex-col pt-7 bg-white">
        <nav className="flex gap-9 self-end mr-16 text-xl font-medium text-right text-black whitespace-nowrap max-md:mr-2.5">
        ...
        <main className="flex flex-col self-center mt-40 w-full max-w-[855px] max-md:mt-10 max-md:max-w-full">
          ...
          <section className="flex flex-col items-center justify-center self-center mt-4 w-full max-w-[858px] max-md:max-w-full">
            <h2 className="text-2xl leading-[60px] text-slate-800 mb-6 text-center">
              Featured Works
            </h2>
