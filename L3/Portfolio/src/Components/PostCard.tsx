...
export const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <div className="dark:bg-black rounded navbarlight">
      <div className="flex flex-col pt-6 pr-12 pb-9 pl-6 w-full rounded  max-md:px-5 ">
        ...
        <div className="flex gap-6 items-start self-start mt-11 text-lg max-md:mt-10">
          ...
          <img
            ...
            className="object-contain shrink-0 w-14px dark:invert aspect-[0.05]"
            alt=""
          />
