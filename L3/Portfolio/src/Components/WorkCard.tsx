    ...
    <div className="flex flex-col max-md:flex-row w-full max-md:w-full gap-5 mb-5">
      ...
      <div className="flex flex-col w-full max-md:w-full">
        <div className="flex flex-col items-start text-slate-800 max-md:mt-5 max-md:max-w-full">
          ...
          <div className="flex gap-7 items-start mt-2.5 text-xl whitespace-nowrap text-slate-400">
            <div className="flex shrink-0 mt-1 rounded-2xl bg-blue-950 h-[25px] w-[62px]">
              {work.year}
            </div>
            <div className="basis-auto">{work.category}</div>
          </div>
