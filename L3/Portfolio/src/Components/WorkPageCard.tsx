...
const WorkCardComponent: React.FC<WorkCardPropss> = ({ work }) => {
  return (
    <div>
      <a href={work.route}>
      <div className="flex flex-row w-full gap-5 mb-5 max-md:flex-col">
        <img
          loading="lazy"
          src={work.image}
          alt={work.title}
        ...
        <div className="flex flex-col  w-full max-md:w-full">
          <div className="flex flex-col h-50 items-start text-slate-800 max-md:mt-2 max-md:max-w-full">
